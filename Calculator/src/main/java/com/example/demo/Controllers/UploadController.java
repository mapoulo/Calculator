...
//	    }
	    ...
	    public String searchAuditLog(@RequestParam String username, @RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate fromDate,@RequestParam @DateTimeFormat(pattern = "yyyy-MM-dd") LocalDate toDate, Model model) {
	    	List<Audit> auditLogEntries = auditService.findByUsernameAndCreatedAtBetween(username, fromDate, toDate);
	        model.addAttribute("auditLogEntries", auditLogEntries);
	    	 return "audit-log";
	    }
